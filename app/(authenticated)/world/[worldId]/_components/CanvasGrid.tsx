...
import { useGridState } from "../_hooks/useGridState";
import { useCanvasInteraction } from "../_hooks/useCanvasInteraction";
import { useViewState } from "../_hooks/useViewState";
...
import GPUCheckDialog, { useGPUCheckDialog } from "./CheckGPUDialog";
import WebGPUValidator from "./WebGPUValidator";
...
const CanvasGrid: React.FC<CanvasGridProps> = ({ worldId }) => {
    ...
    // GPU‐check dialog hook
    const { isOpen, close } = useGPUCheckDialog();
    ...
    }, [adapter, adapterInfo, features, limits, webglInfo, loading, error]);

    // WebGL‐based grid size limits
                        ...
                        <div className="flex flex-col flex-1 h-full overflow-hidden transition-all duration-300 ease-in-out">
                            <div className="flex items-center justify-center flex-1 overflow-hidden bg-gray-200">
                                <GridCanvas
                                    ...
                                    zoomLevel={viewState.zoomLevel}
                                    onMouseDown={
                                        canvasInteraction.handleMouseDown
                                    }
                                    onMouseMove={
