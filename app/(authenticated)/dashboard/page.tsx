...
export default function DashboardPage() {
    return (
        <div className="w-full">
            <Tabs defaultValue="battle-maps">
                <TabsList className="mb-3 border-none w-full grow-0 rounded-none pb-0 pl-5 md:pl-10 fixed z-10">
                    <TabsTrigger
                        value="battle-maps"
                        className="border-b-none rounded-b-none data-[state=active]:shadow-none data-[state=active]:dark:border-none data-[state=active]:dark:bg-background"
                    >
                        <MapPinned />
