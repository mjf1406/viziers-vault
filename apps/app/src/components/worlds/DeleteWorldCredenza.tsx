...
import { deleteConfirmationPhrase } from "@/lib/worlds/worldFormSchema";

type DeleteWorldCredenzaProps = {
  open: boolean;
...
export function DeleteWorldCredenza({
  open,
  onOpenChange,
  entityName,
  onConfirm,
}: DeleteWorldCredenzaProps) {
