...
import i18n, { ensureLocaleLoaded, getInitialLanguage } from "./index";
import { LanguageContext } from "./language-context";
import { LANGUAGE_STORAGE_KEY, writeStoredLanguage } from "./storage";
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (bootLanguage === getI18nLanguage()) {
      return;
    }
    void applyLanguage(bootLanguage);
  }, [applyLanguage]);
